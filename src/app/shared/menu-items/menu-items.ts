...
const MENUITEMS = [
    ...
    },
    {
        ...
        children: [
            { state: 'bin-structure-automatic-creation', name: 'Bin Auto Creation', type: 'link' },
            { state: 'bin-structure-manual-creation', name: 'Bin Manual Creation', type: 'link' },
            { state: 'TO-within-warehouse', name: 'To Within Warehouse', type: 'link' },
            { state: 'pick-list-creation', name: 'Pick List Creation', type: 'link' },
